...
echo "### Automatic selection: Mini version, user 'paquito', password 'pass@123'"
echo
...
# Automatically select Mini version
echo
echo "### Automatically selecting T-Pot Mini installation."
echo
myTPOT_TYPE="HIVE"
...
echo "### Username: ${myWEB_USER}"
echo "### Password: ${myWEB_PW}"
echo
